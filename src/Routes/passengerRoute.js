...
import { registerPassenger, changePassword, loginPassenger,forgotPasswordOTP,resetPasswordWithOtp} from "../Controllers/passengerController.js"; // Use `import` instead of `require`
import {
  registerPassenger,
  changePassword,
  loginPassenger,
